...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    body = None # bytearray | Byte array of file in body of request
    idempotency_key = 'KEY_VALUE' # str | This allows you to safely retry requests without the risk of duplicate processing. 128 character max. (optional)

    try:
        # Creates an attachment on a specific account
        api_response = await api_instance.create_account_attachment_by_file_name(xero_tenant_id, account_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_account_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **body** | **bytearray**| Byte array of file in body of request | 
 **idempotency_key** | **str**| This allows you to safely retry requests without the risk of duplicate processing. 128 character max. | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an attachment for a specific bank transaction by filename
        api_response = await api_instance.create_bank_transaction_attachment_by_file_name(xero_tenant_id, bank_transaction_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transaction_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific bank transactions
        api_response = await api_instance.create_bank_transaction_history_record(xero_tenant_id, bank_transaction_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transaction_history_record:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more spent or received money transaction
        api_response = await api_instance.create_bank_transactions(xero_tenant_id, bank_transactions, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transactions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a bank transfer
        api_response = await api_instance.create_bank_transfer(xero_tenant_id, bank_transfers, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transfer:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.create_bank_transfer_attachment_by_file_name(xero_tenant_id, bank_transfer_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transfer_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific bank transfer
        api_response = await api_instance.create_bank_transfer_history_record(xero_tenant_id, bank_transfer_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_bank_transfer_history_record:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or many batch payments for invoices
        api_response = await api_instance.create_batch_payment(xero_tenant_id, batch_payments, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_batch_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific batch payment
        api_response = await api_instance.create_batch_payment_history_record(xero_tenant_id, batch_payment_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_batch_payment_history_record:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new custom payment service for a specific branding theme
        api_response = await api_instance.create_branding_theme_payment_services(xero_tenant_id, branding_theme_id, payment_services, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_branding_theme_payment_services:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.create_contact_attachment_by_file_name(xero_tenant_id, contact_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_contact_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a contact group
        api_response = await api_instance.create_contact_group(xero_tenant_id, contact_groups, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_contact_group:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates contacts to a specific contact group
        api_response = await api_instance.create_contact_group_contacts(xero_tenant_id, contact_group_id, contacts, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_contact_group_contacts:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new history record for a specific contact
        api_response = await api_instance.create_contact_history(xero_tenant_id, contact_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_contact_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates multiple contacts (bulk) in a Xero organisation
        api_response = await api_instance.create_contacts(xero_tenant_id, contacts, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_contacts:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates allocation for a specific credit note
        api_response = await api_instance.create_credit_note_allocation(xero_tenant_id, credit_note_id, allocations, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_credit_note_allocation:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an attachment for a specific credit note
        api_response = await api_instance.create_credit_note_attachment_by_file_name(xero_tenant_id, credit_note_id, file_name, body, include_online=include_online, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_credit_note_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific credit note
        api_response = await api_instance.create_credit_note_history(xero_tenant_id, credit_note_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_credit_note_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new credit note
        api_response = await api_instance.create_credit_notes(xero_tenant_id, credit_notes, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_credit_notes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a new currency for a Xero organisation
        api_response = await api_instance.create_currency(xero_tenant_id, currency, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_currency:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific expense claim
        api_response = await api_instance.create_expense_claim_history(xero_tenant_id, expense_claim_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_expense_claim_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates expense claims
        api_response = await api_instance.create_expense_claims(xero_tenant_id, expense_claims, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_expense_claims:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an attachment for a specific invoice or purchase bill by filename
        api_response = await api_instance.create_invoice_attachment_by_file_name(xero_tenant_id, invoice_id, file_name, body, include_online=include_online, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific invoice
        api_response = await api_instance.create_invoice_history(xero_tenant_id, invoice_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_invoice_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more sales invoices or purchase bills
        api_response = await api_instance.create_invoices(xero_tenant_id, invoices, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_invoices:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific item
        api_response = await api_instance.create_item_history(xero_tenant_id, item_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_item_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more items
        api_response = await api_instance.create_items(xero_tenant_id, items, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_items:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates linked transactions (billable expenses)
        api_response = await api_instance.create_linked_transaction(xero_tenant_id, linked_transaction, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_linked_transaction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a specific attachment for a specific manual journal by file name
        api_response = await api_instance.create_manual_journal_attachment_by_file_name(xero_tenant_id, manual_journal_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_manual_journal_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific manual journal
        api_response = await api_instance.create_manual_journal_history_record(xero_tenant_id, manual_journal_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_manual_journal_history_record:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more manual journals
        api_response = await api_instance.create_manual_journals(xero_tenant_id, manual_journals, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_manual_journals:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a single allocation for a specific overpayment
        api_response = await api_instance.create_overpayment_allocations(xero_tenant_id, overpayment_id, allocations, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_overpayment_allocations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific overpayment
        api_response = await api_instance.create_overpayment_history(xero_tenant_id, overpayment_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_overpayment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a single payment for invoice or credit notes
        api_response = await api_instance.create_payment(xero_tenant_id, payment, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific payment
        api_response = await api_instance.create_payment_history(xero_tenant_id, payment_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_payment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a payment service
        api_response = await api_instance.create_payment_service(xero_tenant_id, payment_services, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_payment_service:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates multiple payments for invoices or credit notes
        api_response = await api_instance.create_payments(xero_tenant_id, payments, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_payments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Allows you to create an Allocation for prepayments
        api_response = await api_instance.create_prepayment_allocations(xero_tenant_id, prepayment_id, allocations, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_prepayment_allocations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific prepayment
        api_response = await api_instance.create_prepayment_history(xero_tenant_id, prepayment_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_prepayment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates attachment for a specific purchase order
        api_response = await api_instance.create_purchase_order_attachment_by_file_name(xero_tenant_id, purchase_order_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_purchase_order_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific purchase orders
        api_response = await api_instance.create_purchase_order_history(xero_tenant_id, purchase_order_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_purchase_order_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more purchase orders
        api_response = await api_instance.create_purchase_orders(xero_tenant_id, purchase_orders, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_purchase_orders:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates attachment for a specific quote
        api_response = await api_instance.create_quote_attachment_by_file_name(xero_tenant_id, quote_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_quote_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific quote
        api_response = await api_instance.create_quote_history(xero_tenant_id, quote_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_quote_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Create one or more quotes
        api_response = await api_instance.create_quotes(xero_tenant_id, quotes, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_quotes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates draft expense claim receipts for any user
        api_response = await api_instance.create_receipt(xero_tenant_id, receipts, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_receipt:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an attachment on a specific expense claim receipts by file name
        api_response = await api_instance.create_receipt_attachment_by_file_name(xero_tenant_id, receipt_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_receipt_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a history record for a specific receipt
        api_response = await api_instance.create_receipt_history(xero_tenant_id, receipt_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_receipt_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an attachment from a specific repeating invoices by file name
        api_response = await api_instance.create_repeating_invoice_attachment_by_file_name(xero_tenant_id, repeating_invoice_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_repeating_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a  history record for a specific repeating invoice
        api_response = await api_instance.create_repeating_invoice_history(xero_tenant_id, repeating_invoice_id, history_records, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_repeating_invoice_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more repeating invoice templates
        api_response = await api_instance.create_repeating_invoices(xero_tenant_id, repeating_invoices, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_repeating_invoices:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates one or more tax rates
        api_response = await api_instance.create_tax_rates(xero_tenant_id, tax_rates, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_tax_rates:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Create tracking categories
        api_response = await api_instance.create_tracking_category(xero_tenant_id, tracking_category, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_tracking_category:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates options for a specific tracking category
        api_response = await api_instance.create_tracking_options(xero_tenant_id, tracking_category_id, tracking_option, idempotency_key=idempotency_key)
        print("The response of AccountingApi->create_tracking_options:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a chart of accounts
        api_response = await api_instance.delete_account(xero_tenant_id, account_id)
        print("The response of AccountingApi->delete_account:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific batch payment for invoices and credit notes
        api_response = await api_instance.delete_batch_payment(xero_tenant_id, batch_payment_delete, idempotency_key=idempotency_key)
        print("The response of AccountingApi->delete_batch_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific batch payment for invoices and credit notes
        api_response = await api_instance.delete_batch_payment_by_url_param(xero_tenant_id, batch_payment_id, batch_payment_delete_by_url_param, idempotency_key=idempotency_key)
        print("The response of AccountingApi->delete_batch_payment_by_url_param:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific contact from a contact group using a unique contact Id
        await api_instance.delete_contact_group_contact(xero_tenant_id, contact_group_id, contact_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes all contacts from a specific contact group
        await api_instance.delete_contact_group_contacts(xero_tenant_id, contact_group_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes an Allocation from a Credit Note
        api_response = await api_instance.delete_credit_note_allocations(xero_tenant_id, credit_note_id, allocation_id)
        print("The response of AccountingApi->delete_credit_note_allocations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific item
        await api_instance.delete_item(xero_tenant_id, item_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific linked transactions (billable expenses)
        await api_instance.delete_linked_transaction(xero_tenant_id, linked_transaction_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes an Allocation from an overpayment
        api_response = await api_instance.delete_overpayment_allocations(xero_tenant_id, overpayment_id, allocation_id)
        print("The response of AccountingApi->delete_overpayment_allocations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific payment for invoices and credit notes
        api_response = await api_instance.delete_payment(xero_tenant_id, payment_id, payment_delete, idempotency_key=idempotency_key)
        print("The response of AccountingApi->delete_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes an Allocation from a Prepayment
        api_response = await api_instance.delete_prepayment_allocations(xero_tenant_id, prepayment_id, allocation_id)
        print("The response of AccountingApi->delete_prepayment_allocations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific tracking category
        api_response = await api_instance.delete_tracking_category(xero_tenant_id, tracking_category_id)
        print("The response of AccountingApi->delete_tracking_category:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific option for a specific tracking category
        api_response = await api_instance.delete_tracking_options(xero_tenant_id, tracking_category_id, tracking_option_id)
        print("The response of AccountingApi->delete_tracking_options:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Sends a copy of a specific invoice to related contact via email
        await api_instance.email_invoice(xero_tenant_id, invoice_id, request_empty, idempotency_key=idempotency_key)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a single chart of accounts by using a unique account Id
        api_response = await api_instance.get_account(xero_tenant_id, account_id)
        print("The response of AccountingApi->get_account:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_account_attachment_by_file_name(xero_tenant_id, account_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves an attachment for a specific account by filename
        api_response = await api_instance.get_account_attachment_by_file_name(xero_tenant_id, account_id, file_name, content_type)
        print("The response of AccountingApi->get_account_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_account_attachment_by_id(xero_tenant_id, account_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific account using a unique attachment Id
        api_response = await api_instance.get_account_attachment_by_id(xero_tenant_id, account_id, attachment_id, content_type)
        print("The response of AccountingApi->get_account_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific accounts by using a unique account Id
        api_response = await api_instance.get_account_attachments(xero_tenant_id, account_id)
        print("The response of AccountingApi->get_account_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves the full chart of accounts
        api_response = await api_instance.get_accounts(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order)
        print("The response of AccountingApi->get_accounts:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a single spent or received money transaction by using a unique bank transaction Id
        api_response = await api_instance.get_bank_transaction(xero_tenant_id, bank_transaction_id, unitdp=unitdp)
        print("The response of AccountingApi->get_bank_transaction:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_bank_transaction_attachment_by_file_name(xero_tenant_id, bank_transaction_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific bank transaction by filename
        api_response = await api_instance.get_bank_transaction_attachment_by_file_name(xero_tenant_id, bank_transaction_id, file_name, content_type)
        print("The response of AccountingApi->get_bank_transaction_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_bank_transaction_attachment_by_id(xero_tenant_id, bank_transaction_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific attachments from a specific BankTransaction using a unique attachment Id
        api_response = await api_instance.get_bank_transaction_attachment_by_id(xero_tenant_id, bank_transaction_id, attachment_id, content_type)
        print("The response of AccountingApi->get_bank_transaction_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves any attachments from a specific bank transactions
        api_response = await api_instance.get_bank_transaction_attachments(xero_tenant_id, bank_transaction_id)
        print("The response of AccountingApi->get_bank_transaction_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves any spent or received money transactions
        api_response = await api_instance.get_bank_transactions(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, unitdp=unitdp, page_size=page_size)
        print("The response of AccountingApi->get_bank_transactions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history from a specific bank transaction using a unique bank transaction Id
        api_response = await api_instance.get_bank_transactions_history(xero_tenant_id, bank_transaction_id)
        print("The response of AccountingApi->get_bank_transactions_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific bank transfers by using a unique bank transfer Id
        api_response = await api_instance.get_bank_transfer(xero_tenant_id, bank_transfer_id)
        print("The response of AccountingApi->get_bank_transfer:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_bank_transfer_attachment_by_file_name(xero_tenant_id, bank_transfer_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment on a specific bank transfer by file name
        api_response = await api_instance.get_bank_transfer_attachment_by_file_name(xero_tenant_id, bank_transfer_id, file_name, content_type)
        print("The response of AccountingApi->get_bank_transfer_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_bank_transfer_attachment_by_id(xero_tenant_id, bank_transfer_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific bank transfer using a unique attachment ID
        api_response = await api_instance.get_bank_transfer_attachment_by_id(xero_tenant_id, bank_transfer_id, attachment_id, content_type)
        print("The response of AccountingApi->get_bank_transfer_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments from a specific bank transfer
        api_response = await api_instance.get_bank_transfer_attachments(xero_tenant_id, bank_transfer_id)
        print("The response of AccountingApi->get_bank_transfer_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history from a specific bank transfer using a unique bank transfer Id
        api_response = await api_instance.get_bank_transfer_history(xero_tenant_id, bank_transfer_id)
        print("The response of AccountingApi->get_bank_transfer_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves all bank transfers
        api_response = await api_instance.get_bank_transfers(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order)
        print("The response of AccountingApi->get_bank_transfers:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific batch payment using a unique batch payment Id
        api_response = await api_instance.get_batch_payment(xero_tenant_id, batch_payment_id)
        print("The response of AccountingApi->get_batch_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history from a specific batch payment
        api_response = await api_instance.get_batch_payment_history(xero_tenant_id, batch_payment_id)
        print("The response of AccountingApi->get_batch_payment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves either one or many batch payments for invoices
        api_response = await api_instance.get_batch_payments(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order)
        print("The response of AccountingApi->get_batch_payments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific branding theme using a unique branding theme Id
        api_response = await api_instance.get_branding_theme(xero_tenant_id, branding_theme_id)
        print("The response of AccountingApi->get_branding_theme:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves the payment services for a specific branding theme
        api_response = await api_instance.get_branding_theme_payment_services(xero_tenant_id, branding_theme_id)
        print("The response of AccountingApi->get_branding_theme_payment_services:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves all the branding themes
        api_response = await api_instance.get_branding_themes(xero_tenant_id)
        print("The response of AccountingApi->get_branding_themes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific budget, which includes budget lines
        api_response = await api_instance.get_budget(xero_tenant_id, budget_id, date_to=date_to, date_from=date_from)
        print("The response of AccountingApi->get_budget:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_budgets**
> Budgets get_budgets(xero_tenant_id, ids=ids, date_to=date_to, date_from=date_from)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.AccountingApi(api_client)
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    ids = '&quot;00000000-0000-0000-0000-000000000000&quot;' # str | Filter by BudgetID. Allows you to retrieve a specific individual budget. (optional)
    date_to = '2019-10-31' # date | Filter by start date (optional)
    date_from = '2019-10-31' # date | Filter by end date (optional)

    try:
        # Retrieve a list of budgets
        api_response = await api_instance.get_budgets(xero_tenant_id, ids=ids, date_to=date_to, date_from=date_from)
        print("The response of AccountingApi->get_budgets:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **ids** | **str**| Filter by BudgetID. Allows you to retrieve a specific individual budget. | [optional] 
 **date_to** | **date**| Filter by start date | [optional] 
 **date_from** | **date**| Filter by end date | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific contacts in a Xero organisation using a unique contact Id
        api_response = await api_instance.get_contact(xero_tenant_id, contact_id)
        print("The response of AccountingApi->get_contact:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_contact_attachment_by_file_name(xero_tenant_id, contact_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific contact by file name
        api_response = await api_instance.get_contact_attachment_by_file_name(xero_tenant_id, contact_id, file_name, content_type)
        print("The response of AccountingApi->get_contact_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_contact_attachment_by_id(xero_tenant_id, contact_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific contact using a unique attachment Id
        api_response = await api_instance.get_contact_attachment_by_id(xero_tenant_id, contact_id, attachment_id, content_type)
        print("The response of AccountingApi->get_contact_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific contact in a Xero organisation
        api_response = await api_instance.get_contact_attachments(xero_tenant_id, contact_id)
        print("The response of AccountingApi->get_contact_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific contact by contact number in a Xero organisation
        api_response = await api_instance.get_contact_by_contact_number(xero_tenant_id, contact_number)
        print("The response of AccountingApi->get_contact_by_contact_number:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves CIS settings for a specific contact in a Xero organisation
        api_response = await api_instance.get_contact_cis_settings(xero_tenant_id, contact_id)
        print("The response of AccountingApi->get_contact_cis_settings:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific contact group by using a unique contact group Id
        api_response = await api_instance.get_contact_group(xero_tenant_id, contact_group_id)
        print("The response of AccountingApi->get_contact_group:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves the contact Id and name of each contact group
        api_response = await api_instance.get_contact_groups(xero_tenant_id, where=where, order=order)
        print("The response of AccountingApi->get_contact_groups:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records for a specific contact
        api_response = await api_instance.get_contact_history(xero_tenant_id, contact_id)
        print("The response of AccountingApi->get_contact_history:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_contacts**
> Contacts get_contacts(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, ids=ids, page=page, include_archived=include_archived, summary_only=summary_only, search_term=search_term, page_size=page_size)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    order = 'Name ASC' # str | Order by an any element (optional)
    ids = ['&quot;00000000-0000-0000-0000-000000000000&quot;'] # List[str] | Filter by a comma separated list of ContactIDs. Allows you to retrieve a specific set of contacts in a single call. (optional)
    ...
    try:
        # Retrieves all contacts in a Xero organisation
        api_response = await api_instance.get_contacts(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, ids=ids, page=page, include_archived=include_archived, summary_only=summary_only, search_term=search_term, page_size=page_size)
        print("The response of AccountingApi->get_contacts:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **where** | **str**| Filter by an any element | [optional] 
 **order** | **str**| Order by an any element | [optional] 
 **ids** | [**List[str]**](str.md)| Filter by a comma separated list of ContactIDs. Allows you to retrieve a specific set of contacts in a single call. | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific credit note using a unique credit note Id
        api_response = await api_instance.get_credit_note(xero_tenant_id, credit_note_id, unitdp=unitdp)
        print("The response of AccountingApi->get_credit_note:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_credit_note_as_pdf(xero_tenant_id, credit_note_id)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves credit notes as PDF files
        api_response = await api_instance.get_credit_note_as_pdf(xero_tenant_id, credit_note_id)
        print("The response of AccountingApi->get_credit_note_as_pdf:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_credit_note_attachment_by_file_name(xero_tenant_id, credit_note_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment on a specific credit note by file name
        api_response = await api_instance.get_credit_note_attachment_by_file_name(xero_tenant_id, credit_note_id, file_name, content_type)
        print("The response of AccountingApi->get_credit_note_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_credit_note_attachment_by_id(xero_tenant_id, credit_note_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific credit note using a unique attachment Id
        api_response = await api_instance.get_credit_note_attachment_by_id(xero_tenant_id, credit_note_id, attachment_id, content_type)
        print("The response of AccountingApi->get_credit_note_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific credit notes
        api_response = await api_instance.get_credit_note_attachments(xero_tenant_id, credit_note_id)
        print("The response of AccountingApi->get_credit_note_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific credit note
        api_response = await api_instance.get_credit_note_history(xero_tenant_id, credit_note_id)
        print("The response of AccountingApi->get_credit_note_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves any credit notes
        api_response = await api_instance.get_credit_notes(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, unitdp=unitdp, page_size=page_size)
        print("The response of AccountingApi->get_credit_notes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves currencies for your Xero organisation
        api_response = await api_instance.get_currencies(xero_tenant_id, where=where, order=order)
        print("The response of AccountingApi->get_currencies:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific expense claim using a unique expense claim Id
        api_response = await api_instance.get_expense_claim(xero_tenant_id, expense_claim_id)
        print("The response of AccountingApi->get_expense_claim:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific expense claim
        api_response = await api_instance.get_expense_claim_history(xero_tenant_id, expense_claim_id)
        print("The response of AccountingApi->get_expense_claim_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves expense claims
        api_response = await api_instance.get_expense_claims(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order)
        print("The response of AccountingApi->get_expense_claims:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific sales invoice or purchase bill using a unique invoice Id
        api_response = await api_instance.get_invoice(xero_tenant_id, invoice_id, unitdp=unitdp)
        print("The response of AccountingApi->get_invoice:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_invoice_as_pdf**
> bytearray get_invoice_as_pdf(xero_tenant_id, invoice_id)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves invoices or purchase bills as PDF files
        api_response = await api_instance.get_invoice_as_pdf(xero_tenant_id, invoice_id)
        print("The response of AccountingApi->get_invoice_as_pdf:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_invoice_attachment_by_file_name(xero_tenant_id, invoice_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves an attachment from a specific invoice or purchase bill by filename
        api_response = await api_instance.get_invoice_attachment_by_file_name(xero_tenant_id, invoice_id, file_name, content_type)
        print("The response of AccountingApi->get_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_invoice_attachment_by_id(xero_tenant_id, invoice_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific invoices or purchase bills by using a unique attachment Id
        api_response = await api_instance.get_invoice_attachment_by_id(xero_tenant_id, invoice_id, attachment_id, content_type)
        print("The response of AccountingApi->get_invoice_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific invoice or purchase bill
        api_response = await api_instance.get_invoice_attachments(xero_tenant_id, invoice_id)
        print("The response of AccountingApi->get_invoice_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records for a specific invoice
        api_response = await api_instance.get_invoice_history(xero_tenant_id, invoice_id)
        print("The response of AccountingApi->get_invoice_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves invoice reminder settings
        api_response = await api_instance.get_invoice_reminders(xero_tenant_id)
        print("The response of AccountingApi->get_invoice_reminders:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_invoices**
> Invoices get_invoices(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, ids=ids, invoice_numbers=invoice_numbers, contact_ids=contact_ids, statuses=statuses, page=page, include_archived=include_archived, created_by_my_app=created_by_my_app, unitdp=unitdp, summary_only=summary_only, page_size=page_size, search_term=search_term)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    ids = ['&quot;00000000-0000-0000-0000-000000000000&quot;'] # List[str] | Filter by a comma-separated list of InvoicesIDs. (optional)
    invoice_numbers = ['&quot;INV-001&quot;, &quot;INV-002&quot;'] # List[str] | Filter by a comma-separated list of InvoiceNumbers. (optional)
    contact_ids = ['&quot;00000000-0000-0000-0000-000000000000&quot;'] # List[str] | Filter by a comma-separated list of ContactIDs. (optional)
    ...
    try:
        # Retrieves sales invoices or purchase bills
        api_response = await api_instance.get_invoices(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, ids=ids, invoice_numbers=invoice_numbers, contact_ids=contact_ids, statuses=statuses, page=page, include_archived=include_archived, created_by_my_app=created_by_my_app, unitdp=unitdp, summary_only=summary_only, page_size=page_size, search_term=search_term)
        print("The response of AccountingApi->get_invoices:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **where** | **str**| Filter by an any element | [optional] 
 **order** | **str**| Order by an any element | [optional] 
 **ids** | [**List[str]**](str.md)| Filter by a comma-separated list of InvoicesIDs. | [optional] 
 **invoice_numbers** | [**List[str]**](str.md)| Filter by a comma-separated list of InvoiceNumbers. | [optional] 
 **contact_ids** | [**List[str]**](str.md)| Filter by a comma-separated list of ContactIDs. | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific item using a unique item Id
        api_response = await api_instance.get_item(xero_tenant_id, item_id, unitdp=unitdp)
        print("The response of AccountingApi->get_item:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history for a specific item
        api_response = await api_instance.get_item_history(xero_tenant_id, item_id)
        print("The response of AccountingApi->get_item_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves items
        api_response = await api_instance.get_items(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, unitdp=unitdp)
        print("The response of AccountingApi->get_items:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific journal using a unique journal Id.
        api_response = await api_instance.get_journal(xero_tenant_id, journal_id)
        print("The response of AccountingApi->get_journal:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific journal using a unique journal number.
        api_response = await api_instance.get_journal_by_number(xero_tenant_id, journal_number)
        print("The response of AccountingApi->get_journal_by_number:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves journals
        api_response = await api_instance.get_journals(xero_tenant_id, if_modified_since=if_modified_since, offset=offset, payments_only=payments_only)
        print("The response of AccountingApi->get_journals:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific linked transaction (billable expenses) using a unique linked transaction Id
        api_response = await api_instance.get_linked_transaction(xero_tenant_id, linked_transaction_id)
        print("The response of AccountingApi->get_linked_transaction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves linked transactions (billable expenses)
        api_response = await api_instance.get_linked_transactions(xero_tenant_id, page=page, linked_transaction_id=linked_transaction_id, source_transaction_id=source_transaction_id, contact_id=contact_id, status=status, target_transaction_id=target_transaction_id)
        print("The response of AccountingApi->get_linked_transactions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific manual journal
        api_response = await api_instance.get_manual_journal(xero_tenant_id, manual_journal_id)
        print("The response of AccountingApi->get_manual_journal:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_manual_journal_attachment_by_file_name(xero_tenant_id, manual_journal_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific manual journal by file name
        api_response = await api_instance.get_manual_journal_attachment_by_file_name(xero_tenant_id, manual_journal_id, file_name, content_type)
        print("The response of AccountingApi->get_manual_journal_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_manual_journal_attachment_by_id(xero_tenant_id, manual_journal_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Allows you to retrieve a specific attachment from a specific manual journal using a unique attachment Id
        api_response = await api_instance.get_manual_journal_attachment_by_id(xero_tenant_id, manual_journal_id, attachment_id, content_type)
        print("The response of AccountingApi->get_manual_journal_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachment for a specific manual journal
        api_response = await api_instance.get_manual_journal_attachments(xero_tenant_id, manual_journal_id)
        print("The response of AccountingApi->get_manual_journal_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves manual journals
        api_response = await api_instance.get_manual_journals(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, page_size=page_size)
        print("The response of AccountingApi->get_manual_journals:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history for a specific manual journal
        api_response = await api_instance.get_manual_journals_history(xero_tenant_id, manual_journal_id)
        print("The response of AccountingApi->get_manual_journals_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a URL to an online invoice
        api_response = await api_instance.get_online_invoice(xero_tenant_id, invoice_id)
        print("The response of AccountingApi->get_online_invoice:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of the key actions your app has permission to perform in the connected Xero organisation.
        api_response = await api_instance.get_organisation_actions(xero_tenant_id)
        print("The response of AccountingApi->get_organisation_actions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves the CIS settings for the Xero organistaion.
        api_response = await api_instance.get_organisation_cis_settings(xero_tenant_id, organisation_id)
        print("The response of AccountingApi->get_organisation_cis_settings:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves Xero organisation details
        api_response = await api_instance.get_organisations(xero_tenant_id)
        print("The response of AccountingApi->get_organisations:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific overpayment using a unique overpayment Id
        api_response = await api_instance.get_overpayment(xero_tenant_id, overpayment_id)
        print("The response of AccountingApi->get_overpayment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific overpayment
        api_response = await api_instance.get_overpayment_history(xero_tenant_id, overpayment_id)
        print("The response of AccountingApi->get_overpayment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves overpayments
        api_response = await api_instance.get_overpayments(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, unitdp=unitdp, page_size=page_size)
        print("The response of AccountingApi->get_overpayments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific payment for invoices and credit notes using a unique payment Id
        api_response = await api_instance.get_payment(xero_tenant_id, payment_id)
        print("The response of AccountingApi->get_payment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific payment
        api_response = await api_instance.get_payment_history(xero_tenant_id, payment_id)
        print("The response of AccountingApi->get_payment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves payment services
        api_response = await api_instance.get_payment_services(xero_tenant_id)
        print("The response of AccountingApi->get_payment_services:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves payments for invoices and credit notes
        api_response = await api_instance.get_payments(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, page_size=page_size)
        print("The response of AccountingApi->get_payments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Allows you to retrieve a specified prepayments
        api_response = await api_instance.get_prepayment(xero_tenant_id, prepayment_id)
        print("The response of AccountingApi->get_prepayment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history record for a specific prepayment
        api_response = await api_instance.get_prepayment_history(xero_tenant_id, prepayment_id)
        print("The response of AccountingApi->get_prepayment_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves prepayments
        api_response = await api_instance.get_prepayments(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, page=page, unitdp=unitdp, page_size=page_size)
        print("The response of AccountingApi->get_prepayments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific purchase order using a unique purchase order Id
        api_response = await api_instance.get_purchase_order(xero_tenant_id, purchase_order_id)
        print("The response of AccountingApi->get_purchase_order:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_purchase_order_as_pdf(xero_tenant_id, purchase_order_id)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific purchase order as PDF files using a unique purchase order Id
        api_response = await api_instance.get_purchase_order_as_pdf(xero_tenant_id, purchase_order_id)
        print("The response of AccountingApi->get_purchase_order_as_pdf:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_purchase_order_attachment_by_file_name(xero_tenant_id, purchase_order_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment for a specific purchase order by filename
        api_response = await api_instance.get_purchase_order_attachment_by_file_name(xero_tenant_id, purchase_order_id, file_name, content_type)
        print("The response of AccountingApi->get_purchase_order_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_purchase_order_attachment_by_id(xero_tenant_id, purchase_order_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific attachment for a specific purchase order using a unique attachment Id
        api_response = await api_instance.get_purchase_order_attachment_by_id(xero_tenant_id, purchase_order_id, attachment_id, content_type)
        print("The response of AccountingApi->get_purchase_order_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific purchase order
        api_response = await api_instance.get_purchase_order_attachments(xero_tenant_id, purchase_order_id)
        print("The response of AccountingApi->get_purchase_order_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific purchase order using purchase order number
        api_response = await api_instance.get_purchase_order_by_number(xero_tenant_id, purchase_order_number)
        print("The response of AccountingApi->get_purchase_order_by_number:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history for a specific purchase order
        api_response = await api_instance.get_purchase_order_history(xero_tenant_id, purchase_order_id)
        print("The response of AccountingApi->get_purchase_order_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves purchase orders
        api_response = await api_instance.get_purchase_orders(xero_tenant_id, if_modified_since=if_modified_since, status=status, date_from=date_from, date_to=date_to, order=order, page=page, page_size=page_size)
        print("The response of AccountingApi->get_purchase_orders:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific quote using a unique quote Id
        api_response = await api_instance.get_quote(xero_tenant_id, quote_id)
        print("The response of AccountingApi->get_quote:\n")
        pprint(api_response)
    except Exception as e:
...
# **get_quote_as_pdf**
> bytearray get_quote_as_pdf(xero_tenant_id, quote_id)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific quote as a PDF file using a unique quote Id
        api_response = await api_instance.get_quote_as_pdf(xero_tenant_id, quote_id)
        print("The response of AccountingApi->get_quote_as_pdf:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_quote_attachment_by_file_name(xero_tenant_id, quote_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific quote by filename
        api_response = await api_instance.get_quote_attachment_by_file_name(xero_tenant_id, quote_id, file_name, content_type)
        print("The response of AccountingApi->get_quote_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_quote_attachment_by_id(xero_tenant_id, quote_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific quote using a unique attachment Id
        api_response = await api_instance.get_quote_attachment_by_id(xero_tenant_id, quote_id, attachment_id, content_type)
        print("The response of AccountingApi->get_quote_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific quote
        api_response = await api_instance.get_quote_attachments(xero_tenant_id, quote_id)
        print("The response of AccountingApi->get_quote_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history records of a specific quote
        api_response = await api_instance.get_quote_history(xero_tenant_id, quote_id)
        print("The response of AccountingApi->get_quote_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves sales quotes
        api_response = await api_instance.get_quotes(xero_tenant_id, if_modified_since=if_modified_since, date_from=date_from, date_to=date_to, expiry_date_from=expiry_date_from, expiry_date_to=expiry_date_to, contact_id=contact_id, status=status, page=page, order=order, quote_number=quote_number)
        print("The response of AccountingApi->get_quotes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific draft expense claim receipt by using a unique receipt Id
        api_response = await api_instance.get_receipt(xero_tenant_id, receipt_id, unitdp=unitdp)
        print("The response of AccountingApi->get_receipt:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_receipt_attachment_by_file_name(xero_tenant_id, receipt_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific expense claim receipts by file name
        api_response = await api_instance.get_receipt_attachment_by_file_name(xero_tenant_id, receipt_id, file_name, content_type)
        print("The response of AccountingApi->get_receipt_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_receipt_attachment_by_id(xero_tenant_id, receipt_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachments from a specific expense claim receipts by using a unique attachment Id
        api_response = await api_instance.get_receipt_attachment_by_id(xero_tenant_id, receipt_id, attachment_id, content_type)
        print("The response of AccountingApi->get_receipt_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments for a specific expense claim receipt
        api_response = await api_instance.get_receipt_attachments(xero_tenant_id, receipt_id)
        print("The response of AccountingApi->get_receipt_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a history record for a specific receipt
        api_response = await api_instance.get_receipt_history(xero_tenant_id, receipt_id)
        print("The response of AccountingApi->get_receipt_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves draft expense claim receipts for any user
        api_response = await api_instance.get_receipts(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order, unitdp=unitdp)
        print("The response of AccountingApi->get_receipts:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific repeating invoice by using a unique repeating invoice Id
        api_response = await api_instance.get_repeating_invoice(xero_tenant_id, repeating_invoice_id)
        print("The response of AccountingApi->get_repeating_invoice:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_repeating_invoice_attachment_by_file_name(xero_tenant_id, repeating_invoice_id, file_name, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific repeating invoices by file name
        api_response = await api_instance.get_repeating_invoice_attachment_by_file_name(xero_tenant_id, repeating_invoice_id, file_name, content_type)
        print("The response of AccountingApi->get_repeating_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
> bytearray get_repeating_invoice_attachment_by_id(xero_tenant_id, repeating_invoice_id, attachment_id, content_type)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific attachment from a specific repeating invoice
        api_response = await api_instance.get_repeating_invoice_attachment_by_id(xero_tenant_id, repeating_invoice_id, attachment_id, content_type)
        print("The response of AccountingApi->get_repeating_invoice_attachment_by_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves attachments from a specific repeating invoice
        api_response = await api_instance.get_repeating_invoice_attachments(xero_tenant_id, repeating_invoice_id)
        print("The response of AccountingApi->get_repeating_invoice_attachments:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves history record for a specific repeating invoice
        api_response = await api_instance.get_repeating_invoice_history(xero_tenant_id, repeating_invoice_id)
        print("The response of AccountingApi->get_repeating_invoice_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves repeating invoices
        api_response = await api_instance.get_repeating_invoices(xero_tenant_id, where=where, order=order)
        print("The response of AccountingApi->get_repeating_invoices:\n")
        pprint(api_response)
    except Exception as e:
...
> ReportWithRows get_report_aged_payables_by_contact(xero_tenant_id, contact_id, var_date=var_date, from_date=from_date, to_date=to_date)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    contact_id = '00000000-0000-0000-0000-000000000000' # str | Unique identifier for a Contact
    var_date = '2019-10-31' # date | The date of the Aged Payables By Contact report (optional)
    ...
    try:
        # Retrieves report for aged payables by contact
        api_response = await api_instance.get_report_aged_payables_by_contact(xero_tenant_id, contact_id, var_date=var_date, from_date=from_date, to_date=to_date)
        print("The response of AccountingApi->get_report_aged_payables_by_contact:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **contact_id** | **str**| Unique identifier for a Contact | 
 **var_date** | **date**| The date of the Aged Payables By Contact report | [optional] 
...
> ReportWithRows get_report_aged_receivables_by_contact(xero_tenant_id, contact_id, var_date=var_date, from_date=from_date, to_date=to_date)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    contact_id = '00000000-0000-0000-0000-000000000000' # str | Unique identifier for a Contact
    var_date = '2019-10-31' # date | The date of the Aged Receivables By Contact report (optional)
    from_date = '2019-10-31' # date | filter by the from date of the report e.g. 2021-02-01 (optional)
    to_date = '2019-10-31' # date | filter by the to date of the report e.g. 2021-02-28 (optional)

    try:
        # Retrieves report for aged receivables by contact
        api_response = await api_instance.get_report_aged_receivables_by_contact(xero_tenant_id, contact_id, var_date=var_date, from_date=from_date, to_date=to_date)
        print("The response of AccountingApi->get_report_aged_receivables_by_contact:\n")
        pprint(api_response)
    except Exception as e:
 ...
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **contact_id** | **str**| Unique identifier for a Contact | 
 **var_date** | **date**| The date of the Aged Receivables By Contact report | [optional] 
 **from_date** | **date**| filter by the from date of the report e.g. 2021-02-01 | [optional] 
 **to_date** | **date**| filter by the to date of the report e.g. 2021-02-28 | [optional] 
...
> ReportWithRows get_report_balance_sheet(xero_tenant_id, var_date=var_date, periods=periods, timeframe=timeframe, tracking_option_id1=tracking_option_id1, tracking_option_id2=tracking_option_id2, standard_layout=standard_layout, payments_only=payments_only)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.AccountingApi(api_client)
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    var_date = '2019-11-01' # date | The date of the Balance Sheet report (optional)
    ...
    try:
        # Retrieves report for balancesheet
        api_response = await api_instance.get_report_balance_sheet(xero_tenant_id, var_date=var_date, periods=periods, timeframe=timeframe, tracking_option_id1=tracking_option_id1, tracking_option_id2=tracking_option_id2, standard_layout=standard_layout, payments_only=payments_only)
        print("The response of AccountingApi->get_report_balance_sheet:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **var_date** | **date**| The date of the Balance Sheet report | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves report for bank summary
        api_response = await api_instance.get_report_bank_summary(xero_tenant_id, from_date=from_date, to_date=to_date)
        print("The response of AccountingApi->get_report_bank_summary:\n")
        pprint(api_response)
    except Exception as e:
...
> ReportWithRows get_report_budget_summary(xero_tenant_id, var_date=var_date, periods=periods, timeframe=timeframe)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.AccountingApi(api_client)
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    var_date = '2019-03-31' # date | The date for the Bank Summary report e.g. 2018-03-31 (optional)
    ...
    try:
        # Retrieves report for budget summary
        api_response = await api_instance.get_report_budget_summary(xero_tenant_id, var_date=var_date, periods=periods, timeframe=timeframe)
        print("The response of AccountingApi->get_report_budget_summary:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **var_date** | **date**| The date for the Bank Summary report e.g. 2018-03-31 | [optional] 
...
> ReportWithRows get_report_executive_summary(xero_tenant_id, var_date=var_date)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves report for executive summary
        api_response = await api_instance.get_report_executive_summary(xero_tenant_id, var_date=var_date)
        print("The response of AccountingApi->get_report_executive_summary:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific report using a unique ReportID
        api_response = await api_instance.get_report_from_id(xero_tenant_id, report_id)
        print("The response of AccountingApi->get_report_from_id:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves report for profit and loss
        api_response = await api_instance.get_report_profit_and_loss(xero_tenant_id, from_date=from_date, to_date=to_date, periods=periods, timeframe=timeframe, tracking_category_id=tracking_category_id, tracking_category_id2=tracking_category_id2, tracking_option_id=tracking_option_id, tracking_option_id2=tracking_option_id2, standard_layout=standard_layout, payments_only=payments_only)
        print("The response of AccountingApi->get_report_profit_and_loss:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve reports for 1099
        api_response = await api_instance.get_report_ten_ninety_nine(xero_tenant_id, report_year=report_year)
        print("The response of AccountingApi->get_report_ten_ninety_nine:\n")
        pprint(api_response)
    except Exception as e:
...
> ReportWithRows get_report_trial_balance(xero_tenant_id, var_date=var_date, payments_only=payments_only)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.AccountingApi(api_client)
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    var_date = '2019-10-31' # date | The date for the Trial Balance report e.g. 2018-03-31 (optional)
    payments_only = true # bool | Return cash only basis for the Trial Balance report (optional)

    try:
        # Retrieves report for trial balance
        api_response = await api_instance.get_report_trial_balance(xero_tenant_id, var_date=var_date, payments_only=payments_only)
        print("The response of AccountingApi->get_report_trial_balance:\n")
        pprint(api_response)
    except Exception as e:
...
------------- | ------------- | ------------- | -------------
 **xero_tenant_id** | **str**| Xero identifier for Tenant | 
 **var_date** | **date**| The date for the Trial Balance report e.g. 2018-03-31 | [optional] 
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a list of the organistaions unique reports that require a uuid to fetch
        api_response = await api_instance.get_reports_list(xero_tenant_id)
        print("The response of AccountingApi->get_reports_list:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific tax rate according to given TaxType code
        api_response = await api_instance.get_tax_rate_by_tax_type(xero_tenant_id, tax_type)
        print("The response of AccountingApi->get_tax_rate_by_tax_type:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves tax rates
        api_response = await api_instance.get_tax_rates(xero_tenant_id, where=where, order=order)
        print("The response of AccountingApi->get_tax_rates:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves tracking categories and options
        api_response = await api_instance.get_tracking_categories(xero_tenant_id, where=where, order=order, include_archived=include_archived)
        print("The response of AccountingApi->get_tracking_categories:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific tracking categories and options using a unique tracking category Id
        api_response = await api_instance.get_tracking_category(xero_tenant_id, tracking_category_id)
        print("The response of AccountingApi->get_tracking_category:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific user
        api_response = await api_instance.get_user(xero_tenant_id, user_id)
        print("The response of AccountingApi->get_user:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves users
        api_response = await api_instance.get_users(xero_tenant_id, if_modified_since=if_modified_since, where=where, order=order)
        print("The response of AccountingApi->get_users:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Sets the chart of accounts, the conversion date and conversion balances
        api_response = await api_instance.post_setup(xero_tenant_id, setup, idempotency_key=idempotency_key)
        print("The response of AccountingApi->post_setup:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a chart of accounts
        api_response = await api_instance.update_account(xero_tenant_id, account_id, accounts, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_account:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates attachment on a specific account by filename
        api_response = await api_instance.update_account_attachment_by_file_name(xero_tenant_id, account_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_account_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a single spent or received money transaction
        api_response = await api_instance.update_bank_transaction(xero_tenant_id, bank_transaction_id, bank_transactions, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_bank_transaction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment from a specific bank transaction by filename
        api_response = await api_instance.update_bank_transaction_attachment_by_file_name(xero_tenant_id, bank_transaction_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_bank_transaction_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_bank_transfer_attachment_by_file_name(xero_tenant_id, bank_transfer_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_bank_transfer_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific contact in a Xero organisation
        api_response = await api_instance.update_contact(xero_tenant_id, contact_id, contacts, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_contact:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = await api_instance.update_contact_attachment_by_file_name(xero_tenant_id, contact_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_contact_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific contact group
        api_response = await api_instance.update_contact_group(xero_tenant_id, contact_group_id, contact_groups, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_contact_group:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific credit note
        api_response = await api_instance.update_credit_note(xero_tenant_id, credit_note_id, credit_notes, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_credit_note:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates attachments on a specific credit note by file name
        api_response = await api_instance.update_credit_note_attachment_by_file_name(xero_tenant_id, credit_note_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_credit_note_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific expense claims
        api_response = await api_instance.update_expense_claim(xero_tenant_id, expense_claim_id, expense_claims, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_expense_claim:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific sales invoices or purchase bills
        api_response = await api_instance.update_invoice(xero_tenant_id, invoice_id, invoices, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_invoice:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates an attachment from a specific invoices or purchase bill by filename
        api_response = await api_instance.update_invoice_attachment_by_file_name(xero_tenant_id, invoice_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific item
        api_response = await api_instance.update_item(xero_tenant_id, item_id, items, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_item:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific linked transactions (billable expenses)
        api_response = await api_instance.update_linked_transaction(xero_tenant_id, linked_transaction_id, linked_transactions, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_linked_transaction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific manual journal
        api_response = await api_instance.update_manual_journal(xero_tenant_id, manual_journal_id, manual_journals, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_manual_journal:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment from a specific manual journal by file name
        api_response = await api_instance.update_manual_journal_attachment_by_file_name(xero_tenant_id, manual_journal_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_manual_journal_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more spent or received money transaction
        api_response = await api_instance.update_or_create_bank_transactions(xero_tenant_id, bank_transactions, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_bank_transactions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more contacts in a Xero organisation
        api_response = await api_instance.update_or_create_contacts(xero_tenant_id, contacts, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_contacts:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more credit notes
        api_response = await api_instance.update_or_create_credit_notes(xero_tenant_id, credit_notes, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_credit_notes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more sales invoices or purchase bills
        api_response = await api_instance.update_or_create_invoices(xero_tenant_id, invoices, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_invoices:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more items
        api_response = await api_instance.update_or_create_items(xero_tenant_id, items, summarize_errors=summarize_errors, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_items:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates a single manual journal
        api_response = await api_instance.update_or_create_manual_journals(xero_tenant_id, manual_journals, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_manual_journals:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more purchase orders
        api_response = await api_instance.update_or_create_purchase_orders(xero_tenant_id, purchase_orders, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_purchase_orders:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates or creates one or more quotes
        api_response = await api_instance.update_or_create_quotes(xero_tenant_id, quotes, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_quotes:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates or deletes one or more repeating invoice templates
        api_response = await api_instance.update_or_create_repeating_invoices(xero_tenant_id, repeating_invoices, summarize_errors=summarize_errors, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_or_create_repeating_invoices:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific purchase order
        api_response = await api_instance.update_purchase_order(xero_tenant_id, purchase_order_id, purchase_orders, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_purchase_order:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment for a specific purchase order by filename
        api_response = await api_instance.update_purchase_order_attachment_by_file_name(xero_tenant_id, purchase_order_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_purchase_order_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific quote
        api_response = await api_instance.update_quote(xero_tenant_id, quote_id, quotes, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_quote:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment from a specific quote by filename
        api_response = await api_instance.update_quote_attachment_by_file_name(xero_tenant_id, quote_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_quote_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific draft expense claim receipts
        api_response = await api_instance.update_receipt(xero_tenant_id, receipt_id, receipts, unitdp=unitdp, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_receipt:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment on a specific expense claim receipts by file name
        api_response = await api_instance.update_receipt_attachment_by_file_name(xero_tenant_id, receipt_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_receipt_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific repeating invoice template
        api_response = await api_instance.update_repeating_invoice(xero_tenant_id, repeating_invoice_id, repeating_invoices, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_repeating_invoice:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific attachment from a specific repeating invoices by file name
        api_response = await api_instance.update_repeating_invoice_attachment_by_file_name(xero_tenant_id, repeating_invoice_id, file_name, body, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_repeating_invoice_attachment_by_file_name:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates tax rates
        api_response = await api_instance.update_tax_rate(xero_tenant_id, tax_rates, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_tax_rate:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific tracking category
        api_response = await api_instance.update_tracking_category(xero_tenant_id, tracking_category_id, tracking_category, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_tracking_category:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific option for a specific tracking category
        api_response = await api_instance.update_tracking_options(xero_tenant_id, tracking_category_id, tracking_option_id, tracking_option, idempotency_key=idempotency_key)
        print("The response of AccountingApi->update_tracking_options:\n")
        pprint(api_response)
    except Exception as e:
