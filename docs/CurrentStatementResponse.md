...
current_statement_response_instance = CurrentStatementResponse.from_json(json)
# print the JSON string representation of the object
print CurrentStatementResponse.to_json()

# convert the object into a dict
current_statement_response_dict = current_statement_response_instance.to_dict()
# create an instance of CurrentStatementResponse from a dict
current_statement_response_from_dict = CurrentStatementResponse.from_dict(current_statement_response_dict)
```
