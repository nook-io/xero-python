...
employee_leave_setup_instance = EmployeeLeaveSetup.from_json(json)
# print the JSON string representation of the object
print EmployeeLeaveSetup.to_json()

# convert the object into a dict
employee_leave_setup_dict = employee_leave_setup_instance.to_dict()
# create an instance of EmployeeLeaveSetup from a dict
employee_leave_setup_from_dict = EmployeeLeaveSetup.from_dict(employee_leave_setup_dict)
```
