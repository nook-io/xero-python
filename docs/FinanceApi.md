...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.FinanceApi(api_client)
    ...
    try:
        # Get account usage
        api_response = await api_instance.get_accounting_activity_account_usage(xero_tenant_id, start_month=start_month, end_month=end_month)
        print("The response of FinanceApi->get_accounting_activity_account_usage:\n")
        pprint(api_response)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get lock history
        api_response = await api_instance.get_accounting_activity_lock_history(xero_tenant_id, end_date=end_date)
        print("The response of FinanceApi->get_accounting_activity_lock_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get report history
        api_response = await api_instance.get_accounting_activity_report_history(xero_tenant_id, end_date=end_date)
        print("The response of FinanceApi->get_accounting_activity_report_history:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get user activities
        api_response = await api_instance.get_accounting_activity_user_activities(xero_tenant_id, data_month=data_month)
        print("The response of FinanceApi->get_accounting_activity_user_activities:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Bank Statement Accounting
        api_response = await api_instance.get_bank_statement_accounting(xero_tenant_id, bank_account_id, from_date, to_date, summary_only=summary_only)
        print("The response of FinanceApi->get_bank_statement_accounting:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get cash validation
        api_response = await api_instance.get_cash_validation(xero_tenant_id, balance_date=balance_date, as_at_system_date=as_at_system_date, begin_date=begin_date)
        print("The response of FinanceApi->get_cash_validation:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Balance Sheet report
        api_response = await api_instance.get_financial_statement_balance_sheet(xero_tenant_id, balance_date=balance_date)
        print("The response of FinanceApi->get_financial_statement_balance_sheet:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Cash flow report
        api_response = await api_instance.get_financial_statement_cashflow(xero_tenant_id, start_date=start_date, end_date=end_date)
        print("The response of FinanceApi->get_financial_statement_cashflow:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get expense by contacts report
        api_response = await api_instance.get_financial_statement_contacts_expense(xero_tenant_id, contact_ids=contact_ids, include_manual_journals=include_manual_journals, start_date=start_date, end_date=end_date)
        print("The response of FinanceApi->get_financial_statement_contacts_expense:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get revenue by contacts report
        api_response = await api_instance.get_financial_statement_contacts_revenue(xero_tenant_id, contact_ids=contact_ids, include_manual_journals=include_manual_journals, start_date=start_date, end_date=end_date)
        print("The response of FinanceApi->get_financial_statement_contacts_revenue:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Profit & Loss report
        api_response = await api_instance.get_financial_statement_profit_and_loss(xero_tenant_id, start_date=start_date, end_date=end_date)
        print("The response of FinanceApi->get_financial_statement_profit_and_loss:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Trial Balance report
        api_response = await api_instance.get_financial_statement_trial_balance(xero_tenant_id, end_date=end_date)
        print("The response of FinanceApi->get_financial_statement_trial_balance:\n")
        pprint(api_response)
    except Exception as e:
