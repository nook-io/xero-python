...
**period_lock_date** | **str** | Shown if set. See lock dates | [optional] 
**end_of_year_lock_date** | **str** | Shown if set. See lock dates | [optional] 
**created_date_utc** | **str** | Timestamp when the organisation was created in Xero | [optional] [readonly] 
...
**var_class** | **str** | Organisation Classes describe which plan the Xero organisation is on (e.g. DEMO, TRIAL, PREMIUM) | [optional] 
