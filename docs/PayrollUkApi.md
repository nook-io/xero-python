...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    api_instance = xero_python.PayrollUkApi(api_client)
    ...
    try:
        # Approves a specific timesheet
        api_response = await api_instance.approve_timesheet(xero_tenant_id, timesheet_id, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->approve_timesheet:\n")
        pprint(api_response)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new employee benefit
        api_response = await api_instance.create_benefit(xero_tenant_id, benefit, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_benefit:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new deduction
        api_response = await api_instance.create_deduction(xero_tenant_id, deduction, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_deduction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new earnings rate
        api_response = await api_instance.create_earnings_rate(xero_tenant_id, earnings_rate, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_earnings_rate:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates employees
        api_response = await api_instance.create_employee(xero_tenant_id, employee, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    earnings_template = xero_python.EarningsTemplate() # EarningsTemplate | 
    idempotency_key = 'KEY_VALUE' # str | This allows you to safely retry requests without the risk of duplicate processing. 128 character max. (optional)
    ...
    try:
        ...
        print("The response of PayrollUkApi->create_employee_earnings_template:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates leave records for a specific employee
        api_response = await api_instance.create_employee_leave(xero_tenant_id, employee_id, employee_leave, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee_leave:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates employee leave type records
        api_response = await api_instance.create_employee_leave_type(xero_tenant_id, employee_id, employee_leave_type, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee_leave_type:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    employee_id = '4ff1e5cc-9835-40d5-bb18-09fdb118db9c' # str | Employee id for single object
    employee_opening_balance = {statutoryAdoptionPay=10, statutoryMaternityPay=10, statutoryPaternityPay=10, statutorySharedParentalPay=10, statutorySickPay=10, priorEmployeeNumber=10} # List[EmployeeOpeningBalance] | 
    idempotency_key = 'KEY_VALUE' # str | This allows you to safely retry requests without the risk of duplicate processing. 128 character max. (optional)
    ...
    try:
        ...
        print("The response of PayrollUkApi->create_employee_opening_balances:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates an employee payment method
        api_response = await api_instance.create_employee_payment_method(xero_tenant_id, employee_id, payment_method, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee_payment_method:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a salary and wage record for a specific employee
        api_response = await api_instance.create_employee_salary_and_wage(xero_tenant_id, employee_id, salary_and_wage, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee_salary_and_wage:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates statutory sick leave records
        api_response = await api_instance.create_employee_statutory_sick_leave(xero_tenant_id, employee_statutory_sick_leave, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employee_statutory_sick_leave:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates employment detail for a specific employee using a unique employee ID
        api_response = await api_instance.create_employment(xero_tenant_id, employee_id, employment, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_employment:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new leave type
        api_response = await api_instance.create_leave_type(xero_tenant_id, leave_type, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_leave_type:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PayrollUkApi->create_multiple_employee_earnings_template:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new payrun calendar
        api_response = await api_instance.create_pay_run_calendar(xero_tenant_id, pay_run_calendar, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_pay_run_calendar:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new reimbursement
        api_response = await api_instance.create_reimbursement(xero_tenant_id, reimbursement, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_reimbursement:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new timesheet
        api_response = await api_instance.create_timesheet(xero_tenant_id, timesheet, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_timesheet:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates a new timesheet line for a specific timesheet using a unique timesheet ID
        api_response = await api_instance.create_timesheet_line(xero_tenant_id, timesheet_id, timesheet_line, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->create_timesheet_line:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific employee's earnings template record
        await api_instance.delete_employee_earnings_template(xero_tenant_id, employee_id, pay_template_earning_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific employee's leave record
        api_response = await api_instance.delete_employee_leave(xero_tenant_id, employee_id, leave_id)
        print("The response of PayrollUkApi->delete_employee_leave:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a salary and wages record for a specific employee
        await api_instance.delete_employee_salary_and_wage(xero_tenant_id, employee_id, salary_and_wages_id)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific timesheet
        api_response = await api_instance.delete_timesheet(xero_tenant_id, timesheet_id)
        print("The response of PayrollUkApi->delete_timesheet:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes a specific timesheet line
        api_response = await api_instance.delete_timesheet_line(xero_tenant_id, timesheet_id, timesheet_line_id)
        print("The response of PayrollUkApi->delete_timesheet_line:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific benefit by using a unique benefit ID
        api_response = await api_instance.get_benefit(xero_tenant_id, id)
        print("The response of PayrollUkApi->get_benefit:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves employee benefits
        api_response = await api_instance.get_benefits(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_benefits:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific deduction by using a unique deduction ID
        api_response = await api_instance.get_deduction(xero_tenant_id, deduction_id)
        print("The response of PayrollUkApi->get_deduction:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves deductions
        api_response = await api_instance.get_deductions(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_deductions:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific earnings orders by using a unique earnings orders id
        api_response = await api_instance.get_earnings_order(xero_tenant_id, id)
        print("The response of PayrollUkApi->get_earnings_order:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves earnings orders
        api_response = await api_instance.get_earnings_orders(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_earnings_orders:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific earnings rates by using a unique earnings rate id
        api_response = await api_instance.get_earnings_rate(xero_tenant_id, earnings_rate_id)
        print("The response of PayrollUkApi->get_earnings_rate:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves earnings rates
        api_response = await api_instance.get_earnings_rates(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_earnings_rates:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves specific employees by using a unique employee ID
        api_response = await api_instance.get_employee(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave record using a unique employee ID
        api_response = await api_instance.get_employee_leave(xero_tenant_id, employee_id, leave_id)
        print("The response of PayrollUkApi->get_employee_leave:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave balances using a unique employee ID
        api_response = await api_instance.get_employee_leave_balances(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_leave_balances:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave periods using a unique employee ID
        api_response = await api_instance.get_employee_leave_periods(xero_tenant_id, employee_id, start_date=start_date, end_date=end_date)
        print("The response of PayrollUkApi->get_employee_leave_periods:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave types using a unique employee ID
        api_response = await api_instance.get_employee_leave_types(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_leave_types:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave records using a unique employee ID
        api_response = await api_instance.get_employee_leaves(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_leaves:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PayrollUkApi->get_employee_opening_balances:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee pay templates using a unique employee ID
        api_response = await api_instance.get_employee_pay_template(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_pay_template:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's payment method using a unique employee ID
        api_response = await api_instance.get_employee_payment_method(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_payment_method:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific salary and wages record for a specific employee using a unique salary and wage id
        api_response = await api_instance.get_employee_salary_and_wage(xero_tenant_id, employee_id, salary_and_wages_id)
        print("The response of PayrollUkApi->get_employee_salary_and_wage:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's salary and wages by using a unique employee ID
        api_response = await api_instance.get_employee_salary_and_wages(xero_tenant_id, employee_id, page=page)
        print("The response of PayrollUkApi->get_employee_salary_and_wages:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's leave balances using a unique employee ID
        api_response = await api_instance.get_employee_statutory_leave_balances(xero_tenant_id, employee_id, leave_type=leave_type, as_of_date=as_of_date)
        print("The response of PayrollUkApi->get_employee_statutory_leave_balances:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a statutory sick leave for an employee
        api_response = await api_instance.get_employee_statutory_sick_leave(xero_tenant_id, statutory_sick_leave_id)
        print("The response of PayrollUkApi->get_employee_statutory_sick_leave:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves tax records for a specific employee using a unique employee ID
        api_response = await api_instance.get_employee_tax(xero_tenant_id, employee_id)
        print("The response of PayrollUkApi->get_employee_tax:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves employees
        api_response = await api_instance.get_employees(xero_tenant_id, filter=filter, page=page)
        print("The response of PayrollUkApi->get_employees:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific leave type by using a unique leave type ID
        api_response = await api_instance.get_leave_type(xero_tenant_id, leave_type_id)
        print("The response of PayrollUkApi->get_leave_type:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves leave types
        api_response = await api_instance.get_leave_types(xero_tenant_id, page=page, active_only=active_only)
        print("The response of PayrollUkApi->get_leave_types:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific pay run by using a unique pay run ID
        api_response = await api_instance.get_pay_run(xero_tenant_id, pay_run_id)
        print("The response of PayrollUkApi->get_pay_run:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific payrun calendar by using a unique payrun calendar ID
        api_response = await api_instance.get_pay_run_calendar(xero_tenant_id, pay_run_calendar_id)
        print("The response of PayrollUkApi->get_pay_run_calendar:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves payrun calendars
        api_response = await api_instance.get_pay_run_calendars(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_pay_run_calendars:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves pay runs
        api_response = await api_instance.get_pay_runs(xero_tenant_id, page=page, status=status)
        print("The response of PayrollUkApi->get_pay_runs:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific payslip by using a unique payslip ID
        api_response = await api_instance.get_pay_slip(xero_tenant_id, payslip_id)
        print("The response of PayrollUkApi->get_pay_slip:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PayrollUkApi->get_pay_slips:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific reimbursement by using a unique reimbursement id
        api_response = await api_instance.get_reimbursement(xero_tenant_id, reimbursement_id)
        print("The response of PayrollUkApi->get_reimbursement:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves reimbursements
        api_response = await api_instance.get_reimbursements(xero_tenant_id, page=page)
        print("The response of PayrollUkApi->get_reimbursements:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves payroll settings
        api_response = await api_instance.get_settings(xero_tenant_id)
        print("The response of PayrollUkApi->get_settings:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves a specific employee's summary of statutory leaves using a unique employee ID
        api_response = await api_instance.get_statutory_leave_summary(xero_tenant_id, employee_id, active_only=active_only)
        print("The response of PayrollUkApi->get_statutory_leave_summary:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieve a specific timesheet by using a unique timesheet ID
        api_response = await api_instance.get_timesheet(xero_tenant_id, timesheet_id)
        print("The response of PayrollUkApi->get_timesheet:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Retrieves timesheets
        api_response = await api_instance.get_timesheets(xero_tenant_id, page=page, filter=filter, status=status, start_date=start_date, end_date=end_date, sort=sort)
        print("The response of PayrollUkApi->get_timesheets:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PayrollUkApi->get_tracking_categories:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Reverts a specific timesheet to draft
        api_response = await api_instance.revert_timesheet(xero_tenant_id, timesheet_id, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->revert_timesheet:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific employee's detail
        api_response = await api_instance.update_employee(xero_tenant_id, employee_id, employee, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_employee:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of PayrollUkApi->update_employee_earnings_template:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific employee's leave records
        api_response = await api_instance.update_employee_leave(xero_tenant_id, employee_id, leave_id, employee_leave, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_employee_leave:\n")
        pprint(api_response)
    except Exception as e:
...
> EmployeeOpeningBalancesObject update_employee_opening_balances(xero_tenant_id, employee_id, employee_opening_balance, idempotency_key=idempotency_key)
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    xero_tenant_id = 'xero_tenant_id_example' # str | Xero identifier for Tenant
    employee_id = '4ff1e5cc-9835-40d5-bb18-09fdb118db9c' # str | Employee id for single object
    employee_opening_balance = {statutoryAdoptionPay=20, statutoryMaternityPay=20, statutoryPaternityPay=20, statutorySharedParentalPay=20, statutorySickPay=20, priorEmployeeNumber=20} # List[EmployeeOpeningBalance] | 
    idempotency_key = 'KEY_VALUE' # str | This allows you to safely retry requests without the risk of duplicate processing. 128 character max. (optional)

    try:
        # Updates a specific employee's opening balances
        api_response = await api_instance.update_employee_opening_balances(xero_tenant_id, employee_id, employee_opening_balance, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_employee_opening_balances:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates salary and wages record for a specific employee
        api_response = await api_instance.update_employee_salary_and_wage(xero_tenant_id, employee_id, salary_and_wages_id, salary_and_wage, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_employee_salary_and_wage:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific pay run
        api_response = await api_instance.update_pay_run(xero_tenant_id, pay_run_id, pay_run, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_pay_run:\n")
        pprint(api_response)
    except Exception as e:
...
async with xero_python.ApiClient(configuration) as api_client:
    ...
    try:
        # Updates a specific timesheet line for a specific timesheet
        api_response = await api_instance.update_timesheet_line(xero_tenant_id, timesheet_id, timesheet_line_id, timesheet_line, idempotency_key=idempotency_key)
        print("The response of PayrollUkApi->update_timesheet_line:\n")
        pprint(api_response)
    except Exception as e:
