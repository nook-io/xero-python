...
statement_lines_response_instance = StatementLinesResponse.from_json(json)
# print the JSON string representation of the object
print StatementLinesResponse.to_json()

# convert the object into a dict
statement_lines_response_dict = statement_lines_response_instance.to_dict()
# create an instance of StatementLinesResponse from a dict
statement_lines_response_from_dict = StatementLinesResponse.from_dict(statement_lines_response_dict)
```
