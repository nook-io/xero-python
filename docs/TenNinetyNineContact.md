...
ten_ninety_nine_contact_instance = TenNinetyNineContact.from_json(json)
# print the JSON string representation of the object
print TenNinetyNineContact.to_json()

# convert the object into a dict
ten_ninety_nine_contact_dict = ten_ninety_nine_contact_instance.to_dict()
# create an instance of TenNinetyNineContact from a dict
ten_ninety_nine_contact_from_dict = TenNinetyNineContact.from_dict(ten_ninety_nine_contact_dict)
```
