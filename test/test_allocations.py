...
from xero_python.models.allocations import Allocations  # noqa: E501
...
class TestAllocations(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Allocations:
        """Test Allocations
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Allocations`
        """
        model = Allocations()  # noqa: E501
        if include_optional:
            return Allocations(
                allocations = [
