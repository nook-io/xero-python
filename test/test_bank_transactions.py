...
from xero_python.models.bank_transactions import BankTransactions  # noqa: E501
...
class TestBankTransactions(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BankTransactions:
        """Test BankTransactions
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BankTransactions`
        """
        model = BankTransactions()  # noqa: E501
        if include_optional:
            return BankTransactions(
                ...
                bank_transactions = [
                    xero_python.models.bank_transaction.BankTransaction(
                        type = 'RECEIVE', 
                        ...
                        bank_account = xero_python.models.account.Account(
                            code = '4400', 
                            name = 'Food Sales', 
                            account_id = '00000000-0000-0000-0000-000000000000', 
                            bank_account_number = '', 
