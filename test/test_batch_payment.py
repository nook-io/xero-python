...
from xero_python.models.batch_payment import BatchPayment  # noqa: E501
...
class TestBatchPayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPayment:
        """Test BatchPayment
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchPayment`
        """
        model = BatchPayment()  # noqa: E501
        if include_optional:
            return BatchPayment(
