...
from xero_python.models.batch_payments import BatchPayments  # noqa: E501
...
class TestBatchPayments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BatchPayments:
        """Test BatchPayments
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `BatchPayments`
        """
        model = BatchPayments()  # noqa: E501
        if include_optional:
            return BatchPayments(
                batch_payments = [
                    xero_python.models.batch_payment.BatchPayment(
