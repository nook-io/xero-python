...
from xero_python.models.credit_notes import CreditNotes  # noqa: E501
...
class TestCreditNotes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreditNotes:
        """Test CreditNotes
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `CreditNotes`
        """
        model = CreditNotes()  # noqa: E501
        if include_optional:
            return CreditNotes(
