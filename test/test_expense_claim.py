...
from xero_python.models.expense_claim import ExpenseClaim  # noqa: E501
...
class TestExpenseClaim(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExpenseClaim:
        """Test ExpenseClaim
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExpenseClaim`
        """
        model = ExpenseClaim()  # noqa: E501
        if include_optional:
            return ExpenseClaim(
                expense_claim_id = '',
                status = 'SUBMITTED',
