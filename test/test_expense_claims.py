...
from xero_python.models.expense_claims import ExpenseClaims  # noqa: E501
...
class TestExpenseClaims(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExpenseClaims:
        """Test ExpenseClaims
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ExpenseClaims`
        """
        model = ExpenseClaims()  # noqa: E501
        if include_optional:
            return ExpenseClaims(
                expense_claims = [
                    xero_python.models.expense_claim.ExpenseClaim(
                        expense_claim_id = '', 
                        status = 'SUBMITTED', 
                        payments = [
