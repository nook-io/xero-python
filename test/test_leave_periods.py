...
from xero_python.models.leave_periods import LeavePeriods  # noqa: E501


class TestLeavePeriods(unittest.TestCase):
    """LeavePeriods unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LeavePeriods:
        """Test LeavePeriods
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `LeavePeriods`
        """
        model = LeavePeriods()  # noqa: E501
        if include_optional:
            return LeavePeriods(
