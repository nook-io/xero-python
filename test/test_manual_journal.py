...
from xero_python.models.manual_journal import ManualJournal  # noqa: E501
...
class TestManualJournal(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ManualJournal:
        """Test ManualJournal
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ManualJournal`
        """
        model = ManualJournal()  # noqa: E501
        if include_optional:
