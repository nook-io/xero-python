...
from xero_python.models.overpayment import Overpayment  # noqa: E501
...
class TestOverpayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Overpayment:
        """Test Overpayment
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Overpayment`
        """
        model = Overpayment()  # noqa: E501
        if include_optional:
            return Overpayment(
