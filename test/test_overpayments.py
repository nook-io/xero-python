...
from xero_python.models.overpayments import Overpayments  # noqa: E501
...
class TestOverpayments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Overpayments:
        """Test Overpayments
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Overpayments`
        """
        model = Overpayments()  # noqa: E501
        if include_optional:
            return Overpayments(
