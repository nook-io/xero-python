...
from xero_python.models.pay_items import PayItems  # noqa: E501


class TestPayItems(unittest.TestCase):
    """PayItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayItems:
        """Test PayItems
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `PayItems`
        """
        model = PayItems()  # noqa: E501
        if include_optional:
            return PayItems(
                pay_items = xero_python.models.pay_item.PayItem(
                    earnings_rates = [
