...
from xero_python.models.prepayment import Prepayment  # noqa: E501
...
class TestPrepayment(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Prepayment:
        """Test Prepayment
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Prepayment`
        """
        model = Prepayment()  # noqa: E501
        if include_optional:
            return Prepayment(
