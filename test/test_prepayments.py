...
from xero_python.models.prepayments import Prepayments  # noqa: E501
...
class TestPrepayments(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Prepayments:
        """Test Prepayments
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Prepayments`
        """
        model = Prepayments()  # noqa: E501
        if include_optional:
            return Prepayments(
