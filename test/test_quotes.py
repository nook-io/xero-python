...
from xero_python.models.quotes import Quotes  # noqa: E501
...
class TestQuotes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Quotes:
        """Test Quotes
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `Quotes`
        """
        model = Quotes()  # noqa: E501
        if include_optional:
            return Quotes(
                quotes = [
                    xero_python.models.quote.Quote(
                        quote_id = '', 
                        quote_number = '', 
                        reference = '', 
                        terms = '', 
