...
from xero_python.models.repeating_invoice import RepeatingInvoice  # noqa: E501
...
class TestRepeatingInvoice(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RepeatingInvoice:
        """Test RepeatingInvoice
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RepeatingInvoice`
        """
        model = RepeatingInvoice()  # noqa: E501
        if include_optional:
