...
from xero_python.models.repeating_invoices import RepeatingInvoices  # noqa: E501
...
class TestRepeatingInvoices(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RepeatingInvoices:
        """Test RepeatingInvoices
        include_option is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `RepeatingInvoices`
        """
        model = RepeatingInvoices()  # noqa: E501
        if include_optional:
            return RepeatingInvoices(
                repeating_invoices = [
                    xero_python.models.repeating_invoice.RepeatingInvoice(
                        type = 'ACCPAY', 
                        contact = xero_python.models.contact.Contact(
                            ...
                            has_validation_errors = False, 
                            status_attribute_string = '', ), 
                        schedule = xero_python.models.schedule.Schedule(
                            period = 56, 
                            unit = 'WEEKLY', 
                            due_date = 56, 
