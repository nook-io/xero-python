...
class EmployeeLeaveSetupObject(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "leave_setup": "EmployeeLeaveSetup"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "leave_setup": "leaveSetup"}
