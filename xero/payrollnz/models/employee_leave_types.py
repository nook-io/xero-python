...
class EmployeeLeaveTypes(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "leave_types": "list[EmployeeLeaveType]"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "leave_types": "leaveTypes"}
