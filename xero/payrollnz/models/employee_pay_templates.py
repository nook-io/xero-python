...
class EmployeePayTemplates(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "pay_template": "EmployeePayTemplate"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "pay_template": "payTemplate"}
