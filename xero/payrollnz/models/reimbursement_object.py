...
class ReimbursementObject(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "reimbursement": "Reimbursement"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "reimbursement": "reimbursement"}
