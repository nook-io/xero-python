...
class Reimbursements(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "reimbursements": "list[Reimbursement]"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "reimbursements": "reimbursements"}
