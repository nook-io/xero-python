...
class SalaryAndWages(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "salary_and_wages": "list[SalaryAndWage]"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "salary_and_wages": "salaryAndWages"}
