...
class PayRunCalendarObject(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "pay_run_calendar": "PayRunCalendar"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "pay_run_calendar": "payRunCalendar"}
