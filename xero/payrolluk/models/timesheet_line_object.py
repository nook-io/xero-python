...
class TimesheetLineObject(BaseModel):
    openapi_types = {"pagination": "Pagination", "problem": "Problem", "timesheet_line": "TimesheetLine"}
    attribute_map = {"pagination": "pagination", "problem": "problem", "timesheet_line": "timesheetLine"}
