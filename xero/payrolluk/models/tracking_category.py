...
class TrackingCategory(BaseModel):
    openapi_types = {"employee_groups_tracking_category_id": "str", "timesheet_tracking_category_id": "str"}
    attribute_map = {
    ...
    def __init__(self, employee_groups_tracking_category_id=None, timesheet_tracking_category_id=None):
        ...
        if employee_groups_tracking_category_id is not None:
            self.employee_groups_tracking_category_id = employee_groups_tracking_category_id
    ...
    def employee_groups_tracking_category_id(self, employee_groups_tracking_category_id):
        self._employee_groups_tracking_category_id = employee_groups_tracking_category_id
