...
class AppStoreApi:
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_subscription" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_usage_records_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_usage_records" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def post_usage_records_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method post_usage_records" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def put_usage_records_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method put_usage_records" % _key)
            _params[_key] = _val
        del _params["kwargs"]
