...
class AssetApi:
    ...
    async def create_asset(
        ...
        **kwargs,
        ...
        return await self.create_asset_with_http_info(xero_tenant_id, asset, idempotency_key, **kwargs)  # noqa: E501
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method create_asset" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def create_asset_type(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.create_asset_type_with_http_info(xero_tenant_id, asset_type, idempotency_key, **kwargs)  # noqa: E501
    ...
    async def create_asset_type_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method create_asset_type" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_asset_by_id_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_asset_by_id" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_asset_types_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_asset_types" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_assets(
        ...
        sort_direction: Annotated[Optional[StrictStr], Field(description="ASC or DESC")] = None,
        filter_by: Annotated[
            Optional[StrictStr],
            Field(
    ...
    async def get_assets_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_assets" % _key)
            _params[_key] = _val
        del _params["kwargs"]
