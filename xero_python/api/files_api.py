...
from pydantic import Field, StrictBytes, StrictStr, conint, conlist, validate_arguments
...
class FilesApi:
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method create_file_association" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def create_folder(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.create_folder_with_http_info(xero_tenant_id, folder, idempotency_key, **kwargs)  # noqa: E501
    ...
    async def create_folder_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method create_folder" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def delete_file_association(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.delete_file_association_with_http_info(xero_tenant_id, file_id, object_id, **kwargs)  # noqa: E501
    ...
    async def delete_file_association_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method delete_file_association" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def delete_folder(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.delete_folder_with_http_info(xero_tenant_id, folder_id, **kwargs)  # noqa: E501
    ...
    async def delete_folder_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method delete_folder" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_associations_by_object(
        ...
        object_id: Annotated[StrictStr, Field(..., description="Object id for single object")],
        pagesize: Annotated[
            Optional[conint(strict=True, le=100)], Field(description="pass an optional page size value")
        ] = None,
        page: Annotated[
            Optional[conint(strict=True, ge=1)], Field(description="number of records to skip for pagination")
        ] = None,
        sort: Annotated[Optional[StrictStr], Field(description="values to sort by")] = None,
        direction: Annotated[Optional[StrictStr], Field(description="direction to sort by")] = None,
        **kwargs,
    ...
    async def get_associations_by_object_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_associations_by_object" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_associations_count(
        self,
        xero_tenant_id: Annotated[StrictStr, Field(..., description="Xero identifier for Tenant")],
        object_ids: Annotated[conlist(StrictStr), Field(..., description="A comma-separated list of object ids")],
        **kwargs,
    ) -> object:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_associations_count_with_http_info(xero_tenant_id, object_ids, **kwargs)  # noqa: E501
    ...
    async def get_associations_count_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_associations_count" % _key)
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("object_ids") is not None:  # noqa: E501
            ...
            _collection_formats["ObjectIds"] = "csv"
    ...
    async def get_file_associations(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_file_associations_with_http_info(xero_tenant_id, file_id, **kwargs)  # noqa: E501
    ...
    async def get_file_associations_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_file_associations" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_file_content(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_file_content_with_http_info(xero_tenant_id, file_id, **kwargs)  # noqa: E501
    ...
    async def get_file_content_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_file_content" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_files(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_files_with_http_info(xero_tenant_id, pagesize, page, sort, **kwargs)  # noqa: E501
    ...
    async def get_files_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_files" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_folder_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_folder" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_folders_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_folders" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_inbox_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_inbox" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def update_file(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.update_file_with_http_info(xero_tenant_id, file_id, file_object, idempotency_key, **kwargs)  # noqa: E501
    ...
    async def update_file_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method update_file" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def update_folder(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.update_folder_with_http_info(xero_tenant_id, folder_id, folder, idempotency_key, **kwargs)  # noqa: E501
    ...
    async def update_folder_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method update_folder" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def upload_file_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method upload_file" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def upload_file_to_folder_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method upload_file_to_folder" % _key)
            _params[_key] = _val
        del _params["kwargs"]
