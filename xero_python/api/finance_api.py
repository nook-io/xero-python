...
class FinanceApi:
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_accounting_activity_account_usage" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_accounting_activity_lock_history(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_accounting_activity_lock_history_with_http_info(xero_tenant_id, end_date, **kwargs)  # noqa: E501
    ...
    async def get_accounting_activity_lock_history_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_accounting_activity_lock_history" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_accounting_activity_report_history(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_accounting_activity_report_history_with_http_info(xero_tenant_id, end_date, **kwargs)  # noqa: E501
    ...
    async def get_accounting_activity_report_history_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_accounting_activity_report_history" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_accounting_activity_user_activities(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_accounting_activity_user_activities_with_http_info(xero_tenant_id, data_month, **kwargs)  # noqa: E501
    ...
    async def get_bank_statement_accounting_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_bank_statement_accounting" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_cash_validation_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_cash_validation" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_financial_statement_balance_sheet(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_financial_statement_balance_sheet_with_http_info(xero_tenant_id, balance_date, **kwargs)  # noqa: E501
    ...
    async def get_financial_statement_balance_sheet_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_financial_statement_balance_sheet" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_financial_statement_cashflow_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_financial_statement_cashflow" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_financial_statement_trial_balance(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_financial_statement_trial_balance_with_http_info(xero_tenant_id, end_date, **kwargs)  # noqa: E501
    ...
    async def get_financial_statement_trial_balance_with_http_info(
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'" " to method get_financial_statement_trial_balance" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
