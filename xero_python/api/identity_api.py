...
class IdentityApi:
        ...
        **kwargs,
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method delete_connection" % _key)
            _params[_key] = _val
        del _params["kwargs"]
    ...
    async def get_connections(
        self, auth_event_id: Annotated[Optional[StrictStr], Field(description="Filter by authEventId")] = None, **kwargs
    ...
    async def get_connections_with_http_info(
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError("Got an unexpected keyword argument '%s'" " to method get_connections" % _key)
            _params[_key] = _val
        del _params["kwargs"]
