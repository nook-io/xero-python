...
class BenefitObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BenefitObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BenefitObject:
        """Create an instance of BenefitObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BenefitObject.parse_obj(obj)

        _obj = BenefitObject.parse_obj(
            {
                ...
                "benefit": Benefit.from_dict(obj.get("benefit")) if obj.get("benefit") is not None else None,
            }
        )
        return _obj
