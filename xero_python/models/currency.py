...
class Currency(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, alias="Description", description="Name of Currency")
    ...
    def from_dict(cls, obj: dict) -> Currency:
        ...
        _obj = Currency.parse_obj({"code": obj.get("Code"), "description": obj.get("Description")})
        return _obj
