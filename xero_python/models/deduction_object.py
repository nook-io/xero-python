...
class DeductionObject(BaseModel):
    ...
    __properties = ["pagination", "problem", "deduction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeductionObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeductionObject:
        """Create an instance of DeductionObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeductionObject.parse_obj(obj)

        _obj = DeductionObject.parse_obj(
            {
                ...
                "deduction": Deduction.from_dict(obj.get("deduction")) if obj.get("deduction") is not None else None,
            }
        )
        return _obj
