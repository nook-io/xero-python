...
class Deductions(BaseModel):
    ...
    deductions: Optional[conlist(Deduction)] = None
    __properties = ["pagination", "problem", "deductions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Deductions:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Deductions:
        """Create an instance of Deductions from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Deductions.parse_obj(obj)

        _obj = Deductions.parse_obj(
            {
                ...
                "deductions": [Deduction.from_dict(_item) for _item in obj.get("deductions")]
                if obj.get("deductions") is not None
                else None,
            }
        )
        return _obj
