...
class EarningsTemplateObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EarningsTemplateObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EarningsTemplateObject:
        """Create an instance of EarningsTemplateObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EarningsTemplateObject.parse_obj(obj)

        _obj = EarningsTemplateObject.parse_obj(
            {
