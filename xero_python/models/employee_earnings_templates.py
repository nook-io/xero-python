...
class EmployeeEarningsTemplates(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeEarningsTemplates:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeEarningsTemplates:
        """Create an instance of EmployeeEarningsTemplates from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeEarningsTemplates.parse_obj(obj)

        _obj = EmployeeEarningsTemplates.parse_obj(
            {
