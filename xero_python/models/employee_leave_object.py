...
class EmployeeLeaveObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeLeaveObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeLeaveObject:
        """Create an instance of EmployeeLeaveObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeLeaveObject.parse_obj(obj)

        _obj = EmployeeLeaveObject.parse_obj(
            {
                ...
                "leave": EmployeeLeave.from_dict(obj.get("leave")) if obj.get("leave") is not None else None,
            }
        )
        return _obj
