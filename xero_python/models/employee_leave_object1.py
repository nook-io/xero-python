...
class EmployeeLeaveObject1(BaseModel):
    """
    ...
    leave: Optional[EmployeeLeave1] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeLeaveObject1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeLeaveObject1:
        """Create an instance of EmployeeLeaveObject1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeLeaveObject1.parse_obj(obj)

        _obj = EmployeeLeaveObject1.parse_obj(
            {
                ...
                "leave": EmployeeLeave1.from_dict(obj.get("leave")) if obj.get("leave") is not None else None,
            }
        )
        return _obj
