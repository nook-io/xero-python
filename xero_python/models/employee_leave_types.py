...
class EmployeeLeaveTypes(BaseModel):
    ...
    leave_types: Optional[conlist(EmployeeLeaveType)] = Field(default=None, alias="leaveTypes")
    __properties = ["pagination", "problem", "leaveTypes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeLeaveTypes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeLeaveTypes:
        """Create an instance of EmployeeLeaveTypes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeLeaveTypes.parse_obj(obj)

        _obj = EmployeeLeaveTypes.parse_obj(
            {
                ...
                "leave_types": [EmployeeLeaveType.from_dict(_item) for _item in obj.get("leaveTypes")]
