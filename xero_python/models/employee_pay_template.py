...
class EmployeePayTemplate(BaseModel):
    ...
    employee_id: Optional[StrictStr] = Field(
        default=None, alias="employeeID", description="Unique identifier for the employee"
    )
    earning_templates: Optional[conlist(EarningsTemplate)] = Field(default=None, alias="earningTemplates")
    __properties = ["employeeID", "earningTemplates"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeePayTemplate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmployeePayTemplate:
        """Create an instance of EmployeePayTemplate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeePayTemplate.parse_obj(obj)

        _obj = EmployeePayTemplate.parse_obj(
            {
