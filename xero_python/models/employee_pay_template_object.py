...
class EmployeePayTemplateObject(BaseModel):
    ...
    pay_template: Optional[EmployeePayTemplate] = Field(default=None, alias="payTemplate")
    __properties = ["pagination", "problem", "payTemplate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeePayTemplateObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of pay_template
        if self.pay_template:
            _dict["payTemplate"] = self.pay_template.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> EmployeePayTemplateObject:
        """Create an instance of EmployeePayTemplateObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeePayTemplateObject.parse_obj(obj)

        _obj = EmployeePayTemplateObject.parse_obj(
            {
                ...
                "pay_template": EmployeePayTemplate.from_dict(obj.get("payTemplate"))
                if obj.get("payTemplate") is not None
                else None,
            }
        )
        return _obj
