...
class EmployeeStatutoryLeaveBalanceObject(BaseModel):
    ...
    leave_balance: Optional[EmployeeStatutoryLeaveBalance] = Field(default=None, alias="leaveBalance")
    __properties = ["pagination", "problem", "leaveBalance"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmployeeStatutoryLeaveBalanceObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of leave_balance
        if self.leave_balance:
            _dict["leaveBalance"] = self.leave_balance.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> EmployeeStatutoryLeaveBalanceObject:
        """Create an instance of EmployeeStatutoryLeaveBalanceObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmployeeStatutoryLeaveBalanceObject.parse_obj(obj)

        _obj = EmployeeStatutoryLeaveBalanceObject.parse_obj(
            {
                ...
                "leave_balance": EmployeeStatutoryLeaveBalance.from_dict(obj.get("leaveBalance"))
                if obj.get("leaveBalance") is not None
                else None,
            }
        )
        return _obj
