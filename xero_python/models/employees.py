...
class Employees(BaseModel):
    ...
    employees: Optional[conlist(Employee)] = None
    __properties = ["pagination", "problem", "employees"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Employees:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Employees:
        """Create an instance of Employees from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Employees.parse_obj(obj)

        _obj = Employees.parse_obj(
            {
                ...
                "employees": [Employee.from_dict(_item) for _item in obj.get("employees")]
