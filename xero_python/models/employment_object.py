...
class EmploymentObject(BaseModel):
    ...
    __properties = ["pagination", "problem", "employment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EmploymentObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EmploymentObject:
        """Create an instance of EmploymentObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EmploymentObject.parse_obj(obj)

        _obj = EmploymentObject.parse_obj(
            {
                ...
                if obj.get("employment") is not None
                else None,
            }
        )
        return _obj
