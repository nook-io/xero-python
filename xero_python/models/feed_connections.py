...
class FeedConnections(BaseModel):
    ...
    items: Optional[conlist(FeedConnection)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FeedConnections:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FeedConnections:
        """Create an instance of FeedConnections from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FeedConnections.parse_obj(obj)

        _obj = FeedConnections.parse_obj(
            {
                "pagination": Pagination3.from_dict(obj.get("pagination"))
                if obj.get("pagination") is not None
                else None,
                "items": [FeedConnection.from_dict(_item) for _item in obj.get("items")]
