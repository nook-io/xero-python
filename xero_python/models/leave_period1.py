...
class LeavePeriod1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeavePeriod1:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeavePeriod1:
        """Create an instance of LeavePeriod1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeavePeriod1.parse_obj(obj)

        _obj = LeavePeriod1.parse_obj(
            {
