...
class LeaveTypeObject(BaseModel):
    ...
    leave_type: Optional[LeaveType1] = Field(default=None, alias="leaveType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaveTypeObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeaveTypeObject:
        """Create an instance of LeaveTypeObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeaveTypeObject.parse_obj(obj)

        _obj = LeaveTypeObject.parse_obj(
            {
                ...
                "leave_type": LeaveType1.from_dict(obj.get("leaveType")) if obj.get("leaveType") is not None else None,
            }
        )
        return _obj
