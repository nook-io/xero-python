...
class LeaveTypes(BaseModel):
    ...
    leave_types: Optional[conlist(LeaveType1)] = Field(default=None, alias="leaveTypes")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LeaveTypes:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LeaveTypes:
        """Create an instance of LeaveTypes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LeaveTypes.parse_obj(obj)

        _obj = LeaveTypes.parse_obj(
            {
                ...
                "leave_types": [LeaveType1.from_dict(_item) for _item in obj.get("leaveTypes")]
