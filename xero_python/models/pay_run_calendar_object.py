...
class PayRunCalendarObject(BaseModel):
    ...
    pay_run_calendar: Optional[PayRunCalendar] = Field(default=None, alias="payRunCalendar")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayRunCalendarObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayRunCalendarObject:
        """Create an instance of PayRunCalendarObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayRunCalendarObject.parse_obj(obj)

        _obj = PayRunCalendarObject.parse_obj(
            {
                ...
                "pay_run_calendar": PayRunCalendar.from_dict(obj.get("payRunCalendar"))
