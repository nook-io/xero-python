...
class PayRunObject(BaseModel):
    ...
    pay_run: Optional[PayRun] = Field(default=None, alias="payRun")
    __properties = ["pagination", "problem", "payRun"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayRunObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PayRunObject:
        """Create an instance of PayRunObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayRunObject.parse_obj(obj)

        _obj = PayRunObject.parse_obj(
            {
                ...
                "pay_run": PayRun.from_dict(obj.get("payRun")) if obj.get("payRun") is not None else None,
            }
        )
        return _obj
