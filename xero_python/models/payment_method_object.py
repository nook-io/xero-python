...
class PaymentMethodObject(BaseModel):
    ...
    __properties = ["pagination", "problem", "paymentMethod"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentMethodObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentMethodObject:
        """Create an instance of PaymentMethodObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaymentMethodObject.parse_obj(obj)

        _obj = PaymentMethodObject.parse_obj(
            {
                ...
                "payment_method": PaymentMethod.from_dict(obj.get("paymentMethod"))
