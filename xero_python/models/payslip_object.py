...
class PayslipObject(BaseModel):
    ...
    pay_slip: Optional[Payslip] = Field(default=None, alias="paySlip")
    __properties = ["pagination", "problem", "paySlip"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PayslipObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of pay_slip
        if self.pay_slip:
            _dict["paySlip"] = self.pay_slip.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> PayslipObject:
        """Create an instance of PayslipObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PayslipObject.parse_obj(obj)

        _obj = PayslipObject.parse_obj(
            {
                ...
                "pay_slip": Payslip.from_dict(obj.get("paySlip")) if obj.get("paySlip") is not None else None,
            }
        )
        return _obj
