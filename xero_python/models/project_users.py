...
class ProjectUsers(BaseModel):
    ...
    items: Optional[conlist(ProjectUser)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectUsers:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectUsers:
        """Create an instance of ProjectUsers from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectUsers.parse_obj(obj)

        _obj = ProjectUsers.parse_obj(
            {
                "pagination": Pagination2.from_dict(obj.get("pagination"))
                if obj.get("pagination") is not None
                else None,
                "items": [ProjectUser.from_dict(_item) for _item in obj.get("items")]
