...
class Settings(BaseModel):
    ...
    settings: Optional[Accounts1] = None
    __properties = ["pagination", "problem", "settings"]
        ...
        _obj = Settings.parse_obj(
            {
                ...
                "settings": Accounts1.from_dict(obj.get("settings")) if obj.get("settings") is not None else None,
            }
        )
        return _obj
