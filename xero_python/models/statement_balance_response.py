...
class StatementBalanceResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StatementBalanceResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StatementBalanceResponse:
        """Create an instance of StatementBalanceResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StatementBalanceResponse.parse_obj(obj)

        _obj = StatementBalanceResponse.parse_obj({"value": obj.get("value"), "type": obj.get("type")})
        return _obj
