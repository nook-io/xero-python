...
class SuperannuationObject(BaseModel):
    ...
    __properties = ["pagination", "problem", "benefit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SuperannuationObject:
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of benefit
        if self.benefit:
            _dict["benefit"] = self.benefit.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SuperannuationObject:
        """Create an instance of SuperannuationObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SuperannuationObject.parse_obj(obj)

        _obj = SuperannuationObject.parse_obj(
            {
                ...
                "benefit": Benefit1.from_dict(obj.get("benefit")) if obj.get("benefit") is not None else None,
            }
        )
        return _obj
