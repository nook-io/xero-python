...
class Superannuations(BaseModel):
    ...
    benefits: Optional[conlist(Benefit1)] = None
    __properties = ["pagination", "problem", "benefits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Superannuations:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Superannuations:
        """Create an instance of Superannuations from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Superannuations.parse_obj(obj)

        _obj = Superannuations.parse_obj(
            {
                ...
                "benefits": [Benefit1.from_dict(_item) for _item in obj.get("benefits")]
                if obj.get("benefits") is not None
                else None,
            }
        )
        return _obj
