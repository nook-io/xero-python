...
class TaxRates(BaseModel):
    ...
    tax_rates: Optional[conlist(TaxRate)] = Field(default=None, alias="TaxRates")
    __properties = ["TaxRates"]
    ...
    def from_dict(cls, obj: dict) -> TaxRates:
        ...
        _obj = TaxRates.parse_obj(
            {
                "tax_rates": [TaxRate.from_dict(_item) for _item in obj.get("TaxRates")]
                if obj.get("TaxRates") is not None
                else None
            }
        )
        return _obj
