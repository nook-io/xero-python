...
class TimeEntries(BaseModel):
    ...
    items: Optional[conlist(TimeEntry)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimeEntries:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimeEntries:
        """Create an instance of TimeEntries from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimeEntries.parse_obj(obj)

        _obj = TimeEntries.parse_obj(
            {
                "pagination": Pagination2.from_dict(obj.get("pagination"))
                if obj.get("pagination") is not None
                else None,
                "items": [TimeEntry.from_dict(_item) for _item in obj.get("items")]
