...
class TimesheetObject(BaseModel):
    ...
    __properties = ["pagination", "problem", "timesheet"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TimesheetObject:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TimesheetObject:
        """Create an instance of TimesheetObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TimesheetObject.parse_obj(obj)

        _obj = TimesheetObject.parse_obj(
            {
                ...
                "timesheet": Timesheet.from_dict(obj.get("timesheet")) if obj.get("timesheet") is not None else None,
            }
        )
        return _obj
