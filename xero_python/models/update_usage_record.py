...
class UpdateUsageRecord(BaseModel):
    """
    Data transfer object for public update usage end point  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateUsageRecord:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateUsageRecord:
        """Create an instance of UpdateUsageRecord from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateUsageRecord.parse_obj(obj)

        _obj = UpdateUsageRecord.parse_obj({"quantity": obj.get("quantity")})
        return _obj
